...
restxt:
	.ascii	"  \n"
txtlen:
	.quad	7	# bylo long! quad-> wezmie tylko 7, long -> zabierze ta pamiec i 8 bitow kolejnych 
reslen:
	.quad	3
...
disp_line:
	...
	MOV	$stdout,%rdi
	MOV	txtlen,%rdx
	SYSCALL               #pierwsze wywolanie write
...
insert1:
	...
	MOVB	tmp,%al
	SHR	$4,%al  #przesuniecie bitowe o 4 pozycje
	CMPB	$10,%al
	JB	digit2
	ADDB	$('A'-0x0A),%al
	JMP	insert2
...
insert2:
	...
	MOV	$write_64,%rax   #wywolanie funcji write - syscall
	MOV	$stdout,%rdi
	MOV	$restxt,%rsi
	MOV	reslen,%rdx
	SYSCALL
